...
// 1) Implement Priority Queue Using Array: TC= push() - o(1) /  pop() - o(n) / top() - o(n)
class PriorityQ
...
// 2) Implement Priority Queue Using Linked List: TC= push() - o(n) /  pop() - o(1) / top() - o(1)
...
//3) Implement Priority Queue Using Heaps:TC= push() - o(logn) /  pop(logn) - o(n) / top() - o(1)
...
//4) Implement Priority Queue Using Binary Search Tree:  TC= push() - o(1) /  pop() - o(n) / top() - o(n)
