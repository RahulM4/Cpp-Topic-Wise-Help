// Graph has to be weighted grap!!
// Spanning Tree => Graph converted into tree
// Every Node in graph must be rechable
// (N=> vertices) && (N-1 => edges)
// Spanning tree whcih has minimum cost of edges => MST
// To find MST
// Prim's Algo and Kruskals Algo is used

// PROBLEM => Connecting cities with minimum costs
